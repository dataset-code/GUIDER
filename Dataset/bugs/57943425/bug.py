...
X, y = make_classification(100, 100, random_state=42)
...
model.add(Conv2D(32, (3, 3), padding="same", input_shape=input_shape, activation='relu')) # 32 3x3 filters (height, width, depth)
...
model.add(Conv2D(64, (3, 3), padding="same", input_shape=input_shape, activation='relu'))  # 64 3x3 filters
# model.add(Activation("relu"))
model.add(BatchNormalization(axis=channel_dimension))
model.add(Conv2D(64, (3, 3), padding="same", input_shape=input_shape,activation='relu'))  # 64 3x3 filters
# model.add(Activation("relu"))
...
model.add(Conv2D(128, (3, 3), padding="same", input_shape=input_shape,activation='relu'))  # 128 3x3 filters
# model.add(Activation("relu"))
model.add(BatchNormalization(axis=channel_dimension))
model.add(Conv2D(128, (3, 3), padding="same", input_shape=input_shape,activation='relu'))  # 128 3x3 filters
# model.add(Activation("relu"))
